...
/* Descripción de cada uno de los registros del periférico (no necesario para este) */
 ...
 * una escritura "átomica", por lo  cual es preferiblle utilizar el registro BSRR */
...
typedef struct
{
	...
	GPIO_PinConfig_t	pinConfig;	// Hold the configuration for selected PinX
} GPIO_Handler_t;
