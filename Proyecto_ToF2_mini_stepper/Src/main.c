...
void stepper_config(void){
    ...
    /// 1
    IN1.pGPIOx							= GPIOA;
    IN1.pinConfig.GPIO_PinNumber		= PIN_5;
    IN1.pinConfig.GPIO_PinMode			= GPIO_MODE_OUT;
    IN1.pinConfig.GPIO_PinOutputType	= GPIO_OTYPE_PUSHPULL;
    IN1.pinConfig.GPIO_PinOutputSpeed	= GPIO_OSPEED_MEDIUM;
    IN1.pinConfig.GPIO_PinPuPdControl	= GPIO_PUPDR_NOTHING;
    gpio_Config(&IN1);

    /// 2

    IN2.pGPIOx							= GPIOA;
    IN2.pinConfig.GPIO_PinNumber		= PIN_6;
    IN2.pinConfig.GPIO_PinMode			= GPIO_MODE_OUT;
    IN2.pinConfig.GPIO_PinOutputType	= GPIO_OTYPE_PUSHPULL;
    IN2.pinConfig.GPIO_PinOutputSpeed	= GPIO_OSPEED_MEDIUM;
    IN2.pinConfig.GPIO_PinPuPdControl	= GPIO_PUPDR_NOTHING;
    gpio_Config(&IN2);
    ...
    IN3.pGPIOx							= GPIOA;
    IN3.pinConfig.GPIO_PinNumber		= PIN_7;
    IN3.pinConfig.GPIO_PinMode			= GPIO_MODE_OUT;
    IN3.pinConfig.GPIO_PinOutputType	= GPIO_OTYPE_PUSHPULL;
    IN3.pinConfig.GPIO_PinOutputSpeed	= GPIO_OSPEED_MEDIUM;
    IN3.pinConfig.GPIO_PinPuPdControl	= GPIO_PUPDR_NOTHING;
    gpio_Config(&IN3);

     /// 4

    IN4.pGPIOx							= GPIOB;
    IN4.pinConfig.GPIO_PinNumber		= PIN_6;
    IN4.pinConfig.GPIO_PinMode			= GPIO_MODE_OUT;
    IN4.pinConfig.GPIO_PinOutputType	= GPIO_OTYPE_PUSHPULL;
    IN4.pinConfig.GPIO_PinOutputSpeed	= GPIO_OSPEED_MEDIUM;
