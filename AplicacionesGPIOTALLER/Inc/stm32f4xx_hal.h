 ...
 * 	-Distribución básica de la memoria (descrito en la figura 14 de la hora de datos del micro)
 * 	-Posiciones de memoria de los periféricos disponibles en el micro descrito
 * 	la tabla 1 (Memory map)
 ...
 *  Los controladores de las interrupciones se encuentran allí, por ejemplo. Esto se verá a su debido tiempo.
 */
...
/* Posiciones de memoria para periféricos APB1 */
 ...
 * memoria correspondiente, de forma que cad avariable dentro de la estructura coincide con cada uno
 ...
 * periférico GPIO.
 *
 * Debido a que el periférico GPIOx es muyu simple no es muy necesario crear la descripción bit a bit
...
typedef struct
{
	...
	volatile uint32_t AFR[2]; 	// port alternate function registersADDR_OFFSET:    0x20
} GPIO_TypeDef;

/* Creamos un objeto de la estructura definida y hacemos que quede ubicada exactamente sobre la posición
 * de memoria donde se encuentra el registro.
...
/* Incluimos las librerias de cad aperiférico */
